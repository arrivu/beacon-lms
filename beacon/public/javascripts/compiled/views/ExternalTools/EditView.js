  ...
  define(['i18n!external_tools', 'jquery', 'jst/ExternalTools/EditView', 'compiled/views/ValidatedFormView', 'compiled/jquery/fixDialogButtons'], function(I18n, $, template, ValidatedFormView) {
    ...
    return EditView = (function(_super) {
      ...
      EditView.prototype.initialize = function() {
        ...
        return this.title = this.options.title || I18n.t('dialog_title_edit_tool', 'Edit External Tool');
      };
      ...
      EditView.prototype.onSaveFail = function(xhr) {
        ...
        this.$el.prepend("<div class='alert alert-error'>" + message + "</span>");
        delay = function(ms, func) {
          return setTimeout(func, ms);
        };
        return delay(1, function() {
          return this.$("[aria-invalid='true']").first().focus();
        });
      };

(function() {
  ...
  define(['Backbone', 'underscore', 'compiled/views/wiki/WikiPageIndexEditDialog', 'compiled/views/wiki/WikiPageDeleteDialog', 'compiled/views/PublishIconView', 'jst/wiki/WikiPageIndexItem', 'compiled/jquery/redirectClickTo'], function(Backbone, _, WikiPageIndexEditDialog, WikiPageDeleteDialog, PublishIconView, template) {
    ...
    return WikiPageIndexItemView = (function(_super) {
      ...
      WikiPageIndexItemView.prototype.toJSON = function() {
        ...
        _.each(json.wiki_page_menu_tools, function(tool) {
          return tool.url = tool.base_url + ("&pages[]=" + (_this.model.get("page_id")));
        });
        return json;
      };

define(['ember', 'compiled/ember/shared/helpers/common'], function(Ember) {
  Ember.TEMPLATES['create/assignment'] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push(escapeExpression((helper = helpers.input || (depth0 && depth0.input),options={hash:{
    ...
    'class': ("span4"),
    'value': ("model.name"),
    'placeholder': ("text.assignmentName"),
    'aria-label': ("text.assignmentName")
  ...
  data.buffer.push(escapeExpression((helper = helpers['fast-select'] || (depth0 && depth0['fast-select']),options={hash:{
    ...
    'value': ("model.assignment_group_id"),
    'labelPath': ("name"),
    'valuePath': ("id")
  },hashTypes:{'items': "ID",'value': "ID",'labelPath': "STRING",'valuePath': "STRING"},hashContexts:{'items': depth0,'value': depth0,'labelPath': depth0,'valuePath': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "fast-select", options))));
  ...
  stack1 = (helper = helpers.t || (depth0 && depth0.t),options={hash:{
    'scope': ("modules.templates.create.assignment.hbs")

define(['ember', 'compiled/ember/shared/helpers/common'], function(Ember) {
  Ember.TEMPLATES['create/discussion'] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push(escapeExpression((helper = helpers.input || (depth0 && depth0.input),options={hash:{
    ...
    'class': ("span4"),
    'value': ("model.title"),
    'placeholder': ("text.discussionName"),
    'aria-label': ("text.discussionName")
  ...
  stack1 = (helper = helpers.t || (depth0 && depth0.t),options={hash:{
    'scope': ("modules.templates.create.discussion.hbs")
  },hashTypes:{'scope': "STRING"},hashContexts:{'scope': depth0},contexts:[depth0,depth0],types:["STRING","STRING"],data:data},helper ? helper.call(depth0, "create_discussion", "Create Discussion", options) : helperMissing.call(depth0, "t", "create_discussion", "Create Discussion", options));

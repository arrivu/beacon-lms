define(['ember', 'compiled/ember/shared/helpers/common'], function(Ember) {
  Ember.TEMPLATES['add/page'] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
...
function program3(depth0,data) {
  ...
  var buffer = '', stack1;
  data.buffer.push("\n    <li>\n      <label>\n        <input type=\"checkbox\" ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "toggleSelected", "page", {hash:{
    'on': ("change")
...
function program5(depth0,data) {
  ...
  stack1 = (helper = helpers.t || (depth0 && depth0.t),options={hash:{
    'scope': ("modules.templates.add.page.hbs")
  },hashTypes:{'scope': "STRING"},hashContexts:{'scope': depth0},contexts:[depth0,depth0],types:["STRING","STRING"],data:data},helper ? helper.call(depth0, "add_pages", "Add pages", options) : helperMissing.call(depth0, "t", "add_pages", "Add pages", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }

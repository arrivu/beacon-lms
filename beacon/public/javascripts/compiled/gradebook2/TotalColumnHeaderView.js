  ...
  define(['jquery', 'Backbone', 'jst/gradebook2/total_column_header'], function($, Backbone, template) {
    ...
    return TotalColumnHeaderView = (function(_super) {
      ...
      function TotalColumnHeaderView() {
        this.moveColumn = __bind(this.moveColumn, this);
      ...
      TotalColumnHeaderView.prototype.moveColumn = function() {
        this.options.moveTotalColumn();
        this.render();
        return false;
      };
      ...
      TotalColumnHeaderView.prototype.toJSON = function() {
        ...
        return json = {
          ...
          totalColumnInFront: this.options.totalColumnInFront
        };
      };

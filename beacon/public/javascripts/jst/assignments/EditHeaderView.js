...
function program3(depth0,data) {
  ...
  },data:data},helper ? helper.call(depth0, "page_header_title", "New Assignment", options) : helperMissing.call(depth0, "t", "page_header_title", "New Assignment", options));
...
function program7(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.published), {hash:{},inverse:self.program(7, program7, data),fn:self.program(5, program5, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }

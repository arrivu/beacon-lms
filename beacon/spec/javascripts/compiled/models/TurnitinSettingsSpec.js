(function() {
  ...
  define(['compiled/models/TurnitinSettings'], function(TurnitinSettings) {
    ...
    test("assigns originalityReportVisibility", function() {
      ...
      return strictEqual(ts.originalityReportVisibility, 'after_grading');
    });
    test("assigns sPaperCheck", function() {
      ...
      return strictEqual(ts.sPaperCheck, true);
    });
    test("assigns internetCheck", function() {
      ...
      return strictEqual(ts.internetCheck, true);
    });
    test("assigns excludeBiblio", function() {
      ...
      return strictEqual(ts.excludeBiblio, false);
    });
    ...
    test("works with '0' and '1' as well", function() {
      var ts;
      ...
      return strictEqual(ts.journalCheck, false);
    });

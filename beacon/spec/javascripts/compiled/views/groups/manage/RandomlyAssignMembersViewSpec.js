(function() {
  define(['jquery', 'underscore', 'compiled/views/groups/manage/GroupCategoryView', 'compiled/views/groups/manage/RandomlyAssignMembersView', 'compiled/models/GroupCategory', 'helpers/fakeENV'], function($, _, GroupCategoryView, RandomlyAssignMembersView, GroupCategory) {
    ...
    return test('randomly assigns unassigned users', function() {
      ...
      sendResponse("GET", "/api/v1/group_categories/20?includes[]=unassigned_users_count&includes[]=groups_count", JSON.stringify(_.extend({}, groupCategoryResponse, {
        groups_count: 1,

(function() {
  define(['Backbone', 'jquery', 'compiled/views/ExternalTools/AppFullView', 'helpers/assertions', 'helpers/fakeENV', 'helpers/jquery.simulate'], function(Backbone, $, AppFullView, assert, fakeENV) {
    var server, view;
    ...
    module("ExternalTools", {
      setup: function() {
        ...
        model = new Backbone.Model({
          ...
          "extensions": ["editor_button", "resource_selection"],
          "ratings_count": 2,
          "comments_count": 1,
          "avg_rating": 4.5,
    ...
    return test('AppFullView: render', function() {
      assert.isVisible(view.$('.individual-app'));
      equal($('.individual-app h2').text(), "YouTube", 'App name appears as header');
      return equal($('.reviews tr').size(), 1, 'Reviews are shown');
    });
  });

(function() {
  define(['jquery', 'compiled/views/content_migrations/ProgressStatusView', 'compiled/models/ProgressingContentMigration'], function($, ProgressStatusView, ProgressingModel) {

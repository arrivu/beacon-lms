(function() {
  define(['Backbone', 'compiled/models/Quiz', 'compiled/collections/QuizCollection', 'compiled/views/quizzes/IndexView', 'compiled/views/quizzes/QuizItemGroupView', 'compiled/views/quizzes/NoQuizzesView', 'jquery', 'helpers/fakeENV', 'helpers/jquery.simulate'], function(Backbone, Quiz, QuizCollection, IndexView, QuizItemGroupView, NoQuizzesView, $, fakeENV) {
    ...
    return test('should filter models with multiple terms', function() {
      var model, view;

(function() {
  ...
  define(['Backbone', 'compiled/util/mixin', 'helpers/fakeENV'], function(_arg, mixing, fakeENV) {
    var View;
    ...
    return test('View.mixin with compound mixins', function() {
      var Bar, Foo, afterRender1, afterRender2, afterRender3, afterRender4, afterRender5, afterRender6, afterRenderBar, afterRenderFoo, bar, mixin1, mixin2, mixin3, mixin4, mixin5, mixin6, view, _ref, _ref1;
      ...
      Foo = (function(_super) {
        ...
        Foo.mixin(mixin2, mixin3);

        Foo.prototype.afterRender = function() {
          return Foo.__super__.afterRender.apply(this, arguments) && afterRenderFoo();
        };
      ...
      mixin5 = mixing({}, mixin4, {
        afterRender: afterRender5
      });
      mixin6 = {
        afterRender: afterRender6
      };
      ...
      Bar = (function(_super) {
        ...
        Bar.mixin(mixin6, mixin5);

        Bar.prototype.afterRender = function() {
          return Bar.__super__.afterRender.apply(this, arguments) && afterRenderBar();
        };
      ...
      return ok(afterRenderBar.calledOnce, 'called bar afterRender');
    });
  });

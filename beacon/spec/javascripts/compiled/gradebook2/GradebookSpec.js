(function() {
  define(['compiled/gradebook2/Gradebook'], function(Gradebook) {
    module("Gradebook2");
    return test("gradeSort - total_grade", function() {
      var gradeSort;

      gradeSort = function(showTotalGradeAsPoints, a, b, field, asc) {
        if (asc == null) {
          asc = true;
        }

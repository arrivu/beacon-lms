(function() {
  define(['jquery', 'Backbone', 'compiled/views/accounts/admin_tools/CourseSearchResultsView', 'compiled/models/CourseRestore'], function($, Backbone, CourseSearchResultsView, CourseRestore) {

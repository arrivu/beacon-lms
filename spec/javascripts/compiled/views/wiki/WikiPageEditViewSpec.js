(function() {
  define(['jquery', 'compiled/models/WikiPage', 'compiled/views/wiki/WikiPageEditView', 'wikiSidebar'], function($, WikiPage, WikiPageEditView, wikiSidebar) {
    ...
    test('renders escaped angle brackets properly', function() {
      ...
      view.render();
      return equal(view.$wikiPageBody.val(), body);
    });
    ...
    test('warn on leaving if unsaved changes', function() {
      ...
      strictEqual(this.view.onUnload({}), void 0, "No warning if not changed");
      this.titleInput.val('mwhaha');
      return ok(this.view.onUnload({}) !== void 0, "Returns warning if changed");
    });

(function() {
  define(['Backbone', 'compiled/collections/AssignmentGroupCollection', 'compiled/models/AssignmentGroup', 'compiled/models/Assignment', 'compiled/views/assignments/CreateAssignmentView', 'compiled/views/DialogFormView', 'jquery', 'helpers/jquery.simulate', 'compiled/behaviors/tooltip'], function(Backbone, AssignmentGroupCollection, AssignmentGroup, Assignment, CreateAssignmentView, DialogFormView, $) {
    var assignment1, assignment2, assignment3, assignmentGroup, buildAssignment, buildAssignment1, buildAssignment2, buildAssignment3, createView, fixtures;
    ...
    assignment3 = function() {
      return new Assignment(buildAssignment3());
    };
    ...
    test("requires name to save assignment", function() {
      ...
      view = createView(this.assignment3);
      data = {
        name: ""
      };
      ...
      return equal(errors["name"][0]["message"], "Name is required!");
    });
    return test('rejects a letter for points_possible', function() {
      var data, errors, view;

(function() {
  define(['Backbone', 'compiled/models/Quiz', 'compiled/collections/QuizCollection', 'compiled/views/quizzes/QuizItemGroupView', 'jquery', 'helpers/fakeENV', 'helpers/jquery.simulate'], function(Backbone, Quiz, QuizCollection, QuizItemGroupView, $, fakeENV) {

(function() {
  define(['Backbone', 'compiled/models/Quiz', 'compiled/views/quizzes/QuizItemView', 'compiled/views/PublishIconView', 'jquery', 'helpers/fakeENV', 'helpers/jquery.simulate'], function(Backbone, Quiz, QuizItemView, PublishIconView, $, fakeENV) {

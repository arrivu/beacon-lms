(function() {
  ...
  define(['jquery', 'Backbone', 'compiled/views/CollectionView', 'helpers/fakeENV'], function($, Backbone, CollectionView, fakeENV) {
    ...
    assertEmptyTemplateRendered = function() {
      return ok(view.$el.text().match(/No Results/), 'empty template rendered');
    };

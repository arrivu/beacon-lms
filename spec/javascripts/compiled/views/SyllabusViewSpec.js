(function() {
  define(['jquery', 'underscore', 'timezone', 'vendor/timezone/America/Denver', 'compiled/behaviors/SyllabusBehaviors', 'compiled/collections/SyllabusCollection', 'compiled/collections/SyllabusCalendarEventsCollection', 'compiled/collections/SyllabusAppointmentGroupsCollection', 'compiled/views/courses/SyllabusView', 'spec/javascripts/compiled/views/SyllabusViewPrerendered', 'helpers/fakeENV', 'helpers/jquery.simulate'], function($, _, tz, denver, SyllabusBehaviors, SyllabusCollection, SyllabusCalendarEventsCollection, SyllabusAppointmentGroupsCollection, SyllabusView, SyllabusViewPrerendered, fakeENV) {

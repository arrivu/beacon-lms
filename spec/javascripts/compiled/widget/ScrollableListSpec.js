(function() {
  define(['jquery', 'compiled/widget/ScrollableList'], function($, ScrollableList) {
    var scrollableListFixture;

    scrollableListFixture = "<h3>Scrollable List Spec</h3>\n<style>\n  #scrollable_list_container {\n    height: 100px;\n    overflow: hidden;\n  }\n  #scrollable_list_container li {\n    height: 20px;\n  }\n</style>\n<div id=\"scrollable_list_container\"></div>";
    module('ScrollableList', {
      setup: function() {
        ...
        this.fixture = $(scrollableListFixture).appendTo('#fixtures');

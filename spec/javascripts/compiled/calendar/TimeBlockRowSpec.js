(function() {
  ...
  require(['jquery', 'compiled/calendar/TimeBlockList', 'compiled/calendar/TimeBlockRow'], function($, TimeBlockList, TimeBlockRow) {
    ...
    test("should init properly", function() {
      ...
      return equal(me.inputs.end_time.$el.val().trim(), end.toString("h:mm") + end.toString("tt").toLowerCase());
    });

(function() {
  define(['jquery', 'compiled/views/calendar/MissingDateDialogView'], function($, MissingDateDialogView) {
    ...
    return test('should run the success callback on on primary button press', function() {
      this.dialog.render();

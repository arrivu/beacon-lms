(function() {
  ...
  define(['Backbone', 'jquery', 'i18n!user_date_range_search', 'jst/accounts/admin_tools/userDateRangeSearchForm', 'compiled/views/ValidatedMixin', 'jquery.ajaxJSON', 'jquery.instructure_date_and_time', 'compiled/jquery.rails_flash_notifications'], function(Backbone, $, I18n, template, ValidatedMixin) {
    ...
    return UserDateRangeSearchFormView = (function(_super) {
      ...
      function UserDateRangeSearchFormView() {
        ...
        this.resultsFound = __bind(this.resultsFound, this);        _ref = UserDateRangeSearchFormView.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      UserDateRangeSearchFormView.prototype.attach = function() {
        ...
        this.usersView.collection.on('selectedModelChange', this.selectUser);
        return this.usersView.collection.on('sync', this.resultsFound);
      };

      UserDateRangeSearchFormView.prototype.resultsFound = function() {
        return $.screenReaderFlashMessage(I18n.t('results_found', "%{length} results found", {
          length: this.usersView.collection.length
        }));
      };

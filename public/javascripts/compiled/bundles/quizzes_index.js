(function() {
  ...
  require(['i18n!quizzes', 'jquery', 'underscore', 'Backbone', 'compiled/views/quizzes/QuizItemGroupView', 'compiled/views/quizzes/NoQuizzesView', 'compiled/views/quizzes/IndexView', 'compiled/collections/QuizCollection', 'compiled/models/QuizOverrideLoader', 'compiled/util/vddTooltip'], function(I18n, $, _, Backbone, QuizItemGroupView, NoQuizzesView, IndexView, QuizCollection, QuizOverrideLoader, vddTooltip) {
    ...
    QuizzesIndexRouter = (function(_super) {
      ...
      QuizzesIndexRouter.prototype.index = function() {
        ...
        this.view.render();
        if (this.shouldLoadOverrides()) {
          return this.loadOverrides();
        }
      };

      QuizzesIndexRouter.prototype.loadOverrides = function() {
        var quizModels,
          _this = this;

        quizModels = ['assignment', 'open', 'surveys'].reduce(function(out, quizType) {
          return out.concat(_this.quizzes[quizType].collection.models);
        }, []);
        return QuizOverrideLoader(quizModels, ENV.URLS.assignment_overrides);
      };
      ...
      QuizzesIndexRouter.prototype.shouldLoadOverrides = function() {
        return true;
      };

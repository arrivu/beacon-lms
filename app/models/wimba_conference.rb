...
class WimbaConference < WebConference
  ...
  def admin_join_url(user, return_to="http://online.beaconlearning.in")
    add_user_to_conference(user, :presenter) &&
    join_url(user)
  end

  def admin_settings_url(user, return_to="http://online.beaconlearning.in")
    initiate_conference and touch or return nil
    add_user_to_conference(user, :admin) &&
    settings_url(user)
  end

  def participant_join_url(user, return_to="http://online.beaconlearning.in")
